...
function MainContent({
  ...
  return (
    <main className="flex-1 overflow-y-auto bg-transparent min-w-0">
      <div className="sticky top-0 z-10 bg-black/40 backdrop-blur-md border-b border-onyx-border/80 px-4 sm:px-8 py-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {sortEnabled && (
                <div className="relative flex items-center">
                  ...
                  <select
                    ...
                    className="pl-9 pr-2 py-2 bg-onyx-panel/80 backdrop-blur-sm border border-onyx-border text-sm text-white appearance-none cursor-pointer focus:outline-none focus:border-white/40"
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Buscar..."
                  className="pl-9 pr-3 py-2 bg-onyx-panel/80 backdrop-blur-sm border border-onyx-border text-sm text-white w-40 sm:w-52 focus:outline-none focus:border-white/40"
                />
              </div>
              <button
                type="button"
                onClick={onRetry}
                className="p-2 bg-onyx-panel/80 backdrop-blur-sm border border-onyx-border text-white hover:bg-onyx-hover"
                title="Actualizar"
              >
      ...
      <div className="px-4 sm:px-8 py-6">
        {loading ? (
          ...
          <div className="bg-onyx-panel/75 backdrop-blur-md border border-onyx-border/80">
